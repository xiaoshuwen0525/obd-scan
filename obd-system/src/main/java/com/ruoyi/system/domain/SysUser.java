...
public class SysUser extends BaseEntity {
    ...
    public Date getRenewalOrderDate() {
        return renewalOrderDate;
    }

    public void setRenewalOrderDate(Date renewalOrderDate) {
        this.renewalOrderDate = renewalOrderDate;
    }
    ...
    public void setDeptChild(String deptChild) {
